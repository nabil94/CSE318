...
public class Board {
    ...
    public int totStoneOnSide(int id) {
        if (id == 0) {
            ...
            return getTotalStonesAtPlayer2Side();
        }
    }
    ...
    public void togglePlayer() {
        if (player1 == true && player2 == false && playerID == 0) {
            player1 = false;
            player2 = true;
            playerID = 1;
        } else if (player1 == false && player2 == true && playerID == 1) {
            player2 = false;
            player1 = true;
            playerID = 0;
        }
    ...
    public int makeAMove(int currentStorage, int player) {
        ...
        if (player1 == true && player == 0 && currentStorage >= 6) {

        } else if (player2 == true && player == 1 && currentStorage < 6) {

        }
        //if (pots.elementAt(currentStorage).numOfStones > 0) {
        ...
        for (int i = currentStorage + 1; i <= hh; i++) {
            int k = i % 14;
            if (player1 == true && k == 13 && player == 0) {
                //continue;
                //int uu = hh - 13;
                pots.elementAt((hh + 1) % 14).addStones();
                continue;
            } else if (player2 == true && i % 14 == 6 && player == 1) {
                //int uu = hh - 6;
                pots.elementAt((hh + 1) % 14).addStones();
                continue;
            }
